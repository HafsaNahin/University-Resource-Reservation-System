<?php
$str_page = (isset($str_page)) ? $str_page : '';
?>
<nav class="navbar navbar-default navbar-fixed-top" role="navigation" style="margin-bottom: 0">
    <div class="navbar-header">
        ...
        <a class="navbar-brand" href="dashboard.php">
            <b>U</b>niversity <b>R</b>esource <b>R</b>eservation <b>S</b>ystem
        </a>
    </div>
    <!-- /.navbar-header -->

    <ul class="nav navbar-top-links navbar-left">
        <li class="<?php if($str_page == 'dashboard') echo 'active'; ?>">
            <a href="dashboard.php"><i class="fa fa-th-large fa-fw"></i> Dashboard</a>
        </li>
        <li class="<?php if($str_page == 'bookings') echo 'active'; ?>">
            <a href="bookings.php"><i class="fa fa-calendar fa-fw"></i> Bookings</a>
        </li>
